...
func is_player_detected() -> bool:
	print(me.player.global_position.distance_to(me.global_position))
	return can_see_player() or can_hear_player()
...
func can_hear_player() -> bool:
	...
	return me.global_position.distance_to(me.player.global_position) <= hearing_distance
...
func _is_in_sight_cone(target_position: Vector3) -> bool:
	...
	var half_fov = deg_to_rad(sight_angle_degrees * 0.5)
...
func _update_sight_cone_mesh():
	...
	for i in range(segments):
		...
		var p1 = Vector3(sin(a1), 0, -cos(a1)) * sight_distance
		var p2 = Vector3(sin(a2), 0, -cos(a2)) * sight_distance
