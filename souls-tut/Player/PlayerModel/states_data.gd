...
func get_transitions_to_queued(animation: String, timecode: float) -> bool:
	var data = state_database.get_animation(animation)
	var track = data.find_track("StatesDatabase:transitions_to_queued", Animation.TYPE_VALUE)
...
func get_accepts_queueing(animation: String, timecode: float) -> bool:
	var data = state_database.get_animation(animation)
	var track = data.find_track("StatesDatabase:accepts_queueing", Animation.TYPE_VALUE)
	return state_database.get_boolean_value(animation, track, timecode)
