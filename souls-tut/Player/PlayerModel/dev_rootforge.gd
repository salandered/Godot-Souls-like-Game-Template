...
#func DEV_nail_z_coordinate(animation_name : String, into_backend_animation : String, value : float):
		...
		#var backend_animation = state_database.get_animation(into_backend_animation) as Animation
		#var backend_track = backend_animation.find_track("StatesDatabase:root_position", Animation.TYPE_VALUE)
