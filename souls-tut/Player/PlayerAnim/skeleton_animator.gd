...
func configure_blending_times():
	pass
	#set_blend_time("idle_longsword", A.run, 0.3)
	#set_blend_time("landing_run", A.run, 0.5)
	#set_blend_time("jump_sprint", "midair", 0.5)
	#set_blend_time("landing_run", "sprint", 0.3)
	#set_blend_time("landing_sprint", A.run, 0.3)
	...
	#set_blend_time("longsword_1", A.run, 0.3)
