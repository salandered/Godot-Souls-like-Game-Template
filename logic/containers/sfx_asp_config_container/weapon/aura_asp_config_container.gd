...
func _get_whoosh_weapon_config() -> ASPConfig:
	return ASPConfig.new(base_vol + 0.3, -0.1, 5.0, 50.0, 4, 0.3, BusID.GAME_SFX, AURA_PICKING_3)


func _get_hit_weapon_config() -> ASPConfig:
	return ASPConfig.new(base_vol - 0.4, -0.3, 6.0, 80.0, 3, 0.5, BusID.GAME_SFX, TORCH_ATTACK)
