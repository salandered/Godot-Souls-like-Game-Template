...
func _get_footstep_config() -> ASPConfig:
	return ASPConfig.new(fs_base, -0.4, 4.0, 60.0, 3, 0.5)

func _get_fs_bass_config() -> ASPConfig:
	return ASPConfig.new(fs_base, -0.2, 4.0, 60.0, 3, 0.1)
...
func _get_jingle_config() -> ASPConfig:
	return ASPConfig.new(3.0, -0.1, 1.5, 20.0, 3, 0.4, BusID.GAME_SFX, JINGLES)
