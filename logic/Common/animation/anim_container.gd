...
var _animations = [
	...
	AnimationData.new(A.combat_run_f, 1.0),
	AnimationData.new(A.combat_run_b, 1.0),
	AnimationData.new(A.strafe_R, 0.8),
	AnimationData.new(A.strafe_L, 0.8),
	# loco jump
	...
	## fight
	# fight attacks
	AnimationData.new(A.axe_slice_1),
	AnimationData.new(A.axe_slice_2, 0.85),
	# 
