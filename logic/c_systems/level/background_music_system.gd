...
func play_priority_track(
	...
	if _music_asp.playing:
		# Fade to silence
		_fade_tween.tween_property(_music_asp, Constants.Prop.ASP_VOLUME_DB, -80.0, transition_duration)
	...
	# Fade In New Track
	_fade_tween.tween_property(_music_asp, Constants.Prop.ASP_VOLUME_DB, volume_override, transition_duration)
...
func _schedule_end_of_track_fade(stream: AudioStream) -> void:
	...
	_fade_tween.tween_property(_music_asp, Constants.Prop.ASP_VOLUME_DB, -80.0, fade_duration)
