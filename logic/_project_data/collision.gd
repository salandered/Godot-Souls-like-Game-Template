...
##    > StaticBody, All CSG
## ITEM_COL - dynamic objects, like boxes or shatters. NOTE: not the best naming
##    > RigidBody
...
##    > Area
## DEBRIS_COL - inert objects, only collide with environment WARNING: try not to use it, as this is experemental
