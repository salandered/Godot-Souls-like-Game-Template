...
@abstract func _get_char_type() -> DTS.CharacterType


@abstract func _get_dv_type() -> DTS.CharDVType


func get_composite_dtc_key() -> int:
	return DTS.key_char_dv(_get_char_type(), _get_dv_type())
