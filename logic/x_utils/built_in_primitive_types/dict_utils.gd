...
static func safe_get_dict_key(dict: Dictionary, key: Variant, default: Variant = null, warn_level: String = WL.INFO) -> Variant:
...
static func safe_has_key(dict: Dictionary, key: Variant, warn_level: String = WL.INFO) -> bool:
...
static func safe_has_no_key(dict: Dictionary, key: Variant, warn_level: String = WL.INFO) -> bool:
	var exists: bool = key in dict
	if exists:
