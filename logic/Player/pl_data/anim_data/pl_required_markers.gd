...
static var anim_to_required_marker = {
	...
	## air 
	A.air.midair: [],
	A.air.jump_sprint: [MarkerName.JUMP_LAUNCH, MarkerName.PEAK, MarkerName.JUMP_START_END],
	A.air.landing_sprint: [MarkerName.LAND_START, MarkerName.LEG_CONTACT, MarkerName.RUN_AGAIN],
	...
	## fall stand up
	A.fall_stand_up.thrown_r_rm: [MarkerName.FROM_RUN, MarkerName.LAND_START, MarkerName.TO_RUN],
	A.fall_stand_up.thrown_l_rm: [MarkerName.FROM_RUN, MarkerName.LAND_START, MarkerName.TO_RUN],
	A.fall_stand_up.thrown_r_small_rm: [MarkerName.FROM_RUN, MarkerName.LAND_START, MarkerName.TO_RUN],
	A.fall_stand_up.thrown_l_small_rm: [MarkerName.FROM_RUN, MarkerName.LAND_START, MarkerName.TO_RUN],
