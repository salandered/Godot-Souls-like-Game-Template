...
# # anim lib
# var LIB := true
# const _ANIMATION_FOLDER := "res://-assets-/animations/Ready Animations/"
...
# #@export var source_animation_path: String = "res://-assets-/animations/Ready Animations/ss/strafe-R.tres"
# #@export var output_folder: String = "res://-assets-/animations/Ready Animations/split_results/"
