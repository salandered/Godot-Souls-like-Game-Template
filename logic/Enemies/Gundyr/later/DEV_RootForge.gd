...
# TODO: unify with main dev script
...
func DEV_extract_root_position_track(from: String):
	var animation = load("res://-assets-/animations/Ready Animations/HSMECharacter/moving/" + from + ".res") as Animation
	var backend_animation = load("res://-assets-/animations/Ready Animations/HSMECharacter/backend/" + from + "_backend.res") as Animation
...
func DEV_nail_z_coordinate(name: String, value: float):
	var animation = load("res://-assets-/animations/Ready Animations/HSMECharacter/moving/" + name + ".res") as Animation
	...
	ResourceSaver.save(rooted_version, "res://-assets-/animations/Ready Animations/HSMECharacter/rooted/" + name + "_Z_PROJECTED.res")
