...
[("3D View",
  ...
  {"items":
   [("wm.call_menu_pie",
    ...
    ("wm.call_menu_pie",
     ...
     {"properties":
      [("name", 'CURSORPLUS_MT_cursor_plus_pie'),
       ],
      },
     ),
    ("cursorplus.gizmo_presets", {"type": 'D', "value": 'PRESS', "shift": True, "ctrl": True}, None),
    ...
    ("view3d.navigate", {"type": 'BUTTON5MOUSE', "value": 'PRESS'}, None),
    ...
    ("view3d.view_selected", {"type": 'F', "value": 'PRESS', "alt": True, "repeat": True}, None),
    ],
   },
  ),
 ("3D View Generic",
 ...
 ("3D View Tool: Edit Mesh, PolyQuilt",
  {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
  {"items":
   [("none.poly_quilt_daemon", {"type": 'MOUSEMOVE', "value": 'ANY'}, None),
    ("mesh.poly_quilt",
    ...
    ("mesh.poly_quilt",
     {"type": 'LEFTMOUSE', "value": 'PRESS', "ctrl": True, "oskey": True},
     {"properties":
      [("tool_mode", 'NONE'),
       ],
      },
 ...
 ("Gizmo PRO Tweak",
  {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
  {"items":
   [("gizmogroup.gizmo_tweak", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG', "shift": -1, "ctrl": -1, "hyper": -1}, None),
    ("gizmogroup.gizmo_tweak", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG', "shift": -1, "ctrl": -1, "hyper": -1}, None),
    ],
   },
  ),
 ("Image",
  ...
  {"items":
   [("image.view_all", {"type": 'HOME', "value": 'PRESS'}, None),
    ...
    ("image.view_selected", {"type": 'FOUR', "value": 'PRESS'}, None),
 ...
 ("Object Non-modal",
  ...
  {"items":
   [("object.mode_set",
    ...
    ("view3d.object_mode_pie_or_toggle", {"type": 'BUTTON4MOUSE', "value": 'PRESS'}, None),
    ],
   },
  ),
 ("Outliner",
  ...
  {"items":
   [("outliner.highlight_update", {"type": 'MOUSEMOVE', "value": 'ANY', "any": True}, None),
    ...
    ("outliner.show_active", {"type": 'ACCENT_GRAVE', "value": 'PRESS'}, None),
    ("outliner.show_active", {"type": 'F', "value": 'PRESS', "alt": True}, None),
 ...
 ("Window",
  ...
  {"items":
   [("wm.blenderkit_menu_rating_upload", {"type": 'R', "value": 'PRESS'}, None),
    ...
    ("wm.search_menu", {"type": 'P', "value": 'PRESS', "shift": True, "ctrl": True}, None),
    ("wm.call_menu",
     {"type": 'F4', "value": 'PRESS'},
     {"properties":
    ...
    ("wm.context_toggle",
     ...
     {"properties":
      [("data_path", 'scene.GP_scene_set.show_gizmo'),
       ],
      },
     ),
    ("wm.context_menu_enum",
     ...
     {"properties":
      [("data_path", 'space_data.shading.color_type'),
       ],
      },
     ),
    ],
