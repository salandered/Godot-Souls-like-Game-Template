...
# --- CONFIGURATION ---
# Set these constants to match your animation.

# The frame you want to become the new start of the animation.
NEW_START_FRAME = 12

# The current start and end frames of your animation's content.
...
# Call the function with the selected object and the configuration
try:
