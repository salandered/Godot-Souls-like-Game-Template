...
# 		return VerdictPH.new(["kick", "elbow"].pick_random())
...
# func _rotate(delta):
# 	var adjusted_direction = e_movement.direction_to_player().rotated(Vector3.UP, angle_adjustment)
