...
# 	input = map_with_dictionary(input_, behavior_map)
...
# func choose_initial_behavior(input_: InputPackage):
# 	switch_action_to("charge", input)
...
# 	choose_action(input_)

# func choose_action(input_: InputPackage):
...
# func setup_legs_animator(previous_action: LegsAction, input_: InputPackage):
