...
# 	if input_.actions.has("slash_1") and slash_1.works_longer_than(PANIC_CLICK_PREVENTION):
# 		return true
# 	return false
...
# func is_triggered(input_: InputPackage) -> bool:
# 	if input_.actions.has("slash_1") and slash_2.works_longer_than(PANIC_CLICK_PREVENTION):
# 		return true
# 	return false
# endregion