...
## UI for the asynchronous loading process managed by SceneLoader.
## A controller script for a visual, user-facing loading screen.
## It visualizes the loading progress from the SceneLoader autoload by updating a progress bar and a text label.
