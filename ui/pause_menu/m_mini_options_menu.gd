...
func _add_audio_bus_controls() -> void:
	for bus_iter in AudioServer.bus_count:
		var bus_name: String = M_AppSettings.get_audio_bus_name(bus_iter)
...
func _update_ui() -> void:
	...
	fullscreen_control.value = M_AppSettings.is_fullscreen(get_window())
...
func _on_fullscreen_control_setting_changed(value: bool) -> void:
	M_AppSettings.set_display_mode(value, get_window())
